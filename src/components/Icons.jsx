...
export function SunIcon() {
  return (
    <svg className="w-12 h-12 text-yellow-500" fill="currentColor" viewBox="0 0 24 24">
      ...
      <path d="M12 1v6m0 6v6M23 12h-6m-6 0H1M20.485 3.515l-4.242 4.242m-8.486 0l-4.242-4.242M20.485 20.485l-4.242-4.242m-8.486 0l-4.242 4.242" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" />
    </svg>
  )
}
